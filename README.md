...
- to show the inner and outer part of the reconstructed megalithic grave, a diiferent navigar´tion button from 3DHOP was repurposed to make a second 3D model appear or disappear in the 3D viewer. The icon was also changed to better fit the topic.

```html
<img id="layer_on" title="Disable Outer Layer" src="skins/dark/menu_on.png"
  style="position:absolute; visibility:hidden;" />
<img id="layer" title="Enable Outer Layer" src="skins/dark/menu.png" /><br />
```
...
Now when cklicking the Home button, the 3D model resets to its starting position, the second added model disappears and also the toolbar is reset.
